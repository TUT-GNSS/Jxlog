...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void EffectiveMsg::set_file_name(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.file_name_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:EffectiveMsg.file_name)
}
inline std::string* EffectiveMsg::mutable_file_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void EffectiveMsg::set_allocated_file_name(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
